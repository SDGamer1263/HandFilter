...
app = BUNDLE(
    ...
    name='HandFilter.app',
    icon='hand_filter.icns',
    bundle_identifier='com.sdgamer1263.handfilter',
    info_plist={
        'NSCameraUsageDescription': 'HandFilter needs camera access for hand tracking.',
        'NSMicrophoneUsageDescription': 'HandFilter does not use the microphone.',
